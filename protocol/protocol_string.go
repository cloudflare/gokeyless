// Code generated by "stringer -type=Tag,Op,ComplianceRegion -output=protocol_string.go"; DO NOT EDIT.
...
func _() {
	...
	_ = x[TagReqContext-22]
	_ = x[TagComplianceRegion-23]
	_ = x[TagPadding-32]
}

const (
	_Tag_name_0 = "TagCertificateDigestTagServerNameTagClientIPTagSubjectKeyIdentifierTagServerIPTagCertID"
	_Tag_name_1 = "TagOpcodeTagPayloadTagCustomFuncNameTagExtraTagJaegerSpanTagReqContextTagComplianceRegion"
	_Tag_name_2 = "TagPadding"
)

var (
	_Tag_index_0 = [...]uint8{0, 20, 33, 44, 67, 78, 87}
	_Tag_index_1 = [...]uint8{0, 9, 19, 36, 44, 57, 70, 89}
)
...
func _() {
	...
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[ComplianceRegionFedRAMPHigh-1]
}

const _ComplianceRegion_name = "ComplianceRegionFedRAMPHigh"

var _ComplianceRegion_index = [...]uint8{0, 27}

func (i ComplianceRegion) String() string {
	i -= 1
	if i >= ComplianceRegion(len(_ComplianceRegion_index)-1) {
		return "ComplianceRegion(" + strconv.FormatInt(int64(i+1), 10) + ")"
	}
	return _ComplianceRegion_name[_ComplianceRegion_index[i]:_ComplianceRegion_index[i+1]]
}
