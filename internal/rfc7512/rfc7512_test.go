...
pkcs11:token=A;manufacturer=B;serial=C;model=D;library-manufacturer=E;library-description=F;library-version=G;object=H;type=I;id=J;slot-manufacturer=K;slot-description=L;slot-id=1234567890?pin-source=N&pin-value=O&module-name=P&module-path=Q&max-sessions=10&idle-timeout=100ms`
